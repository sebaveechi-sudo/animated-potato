...
class SimulationWindow(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Iniciar Loop de refresco visual
        self.actualizar_gui()
    ...
    def dibujar_mapa(self):
        ...
        # Escala: 400km aprox (Santiago a Chillán) -> Pixeles
        ...
        for est in self.sim_state.estaciones:
            ...
            # Gente esperando (texto pequeño arriba)
    ...
    def actualizar_gui(self):
        ...
        # 3. Redibujar mapa si la ventana es visible
        if self.winfo_viewable():
            self.dibujar_mapa()

        # 4. Programar siguiente frame (100ms = 10 FPS)
